...
module.exports = {
  ...
  siteUrl: process.env.NEXT_PUBLIC_SITE_URL || 'https://portify-production.up.railway.app',
  ...
  robotsTxtOptions: {
    ...
    additionalSitemaps: [
      `${process.env.NEXT_PUBLIC_SITE_URL || 'https://portify-production.up.railway.app'}/server-sitemap.xml`,
    ],
  },
};
